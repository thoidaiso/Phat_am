...
import com.example.utils.AppStatus;
...
public class MainActivity extends SherlockFragmentActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		TwoTextArrayAdapter adapter = new TwoTextArrayAdapter(this,
				getListMenuItem());
	...
	public List<Item> getListMenuItem() {
		...
		String[] list_category_array = getResources().getStringArray(
				R.array.list_category_array);
		final Integer[] Icons_category = { R.drawable.ic_menu_category,
				R.drawable.ic_menu_people, R.drawable.ic_menu_top,
				R.drawable.ic_menu_new, R.drawable.ic_menu_random,
