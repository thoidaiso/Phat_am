...
//  private AtomicBoolean keepOnAppending=new AtomicBoolean(true);
  private boolean keepOnAppending = false;
...
//  }
  ...
  public EndlessAdapter(Activity context, int layout, ArrayList<Model_Video> list, ArrayAdapter<Model_Video> adapter) {
	  super(context, R.layout.loadmore_video_list_item, list, adapter);
...
public int getViewTypeCount() {
  ...
  public Model_Video getItem(int position) {
	Log.v("get item in endless adapter",""+position);
  ...
  public View getView(int position, View convertView, ViewGroup parent) {
	Log.v("Call getview of enless","");
    if (position == super.getCount() && keepOnAppending) {
      if (pendingView == null) {
  ...
  private void setKeepOnAppending(boolean keepOnAppending2) {
    boolean same=(keepOnAppending2==keepOnAppending);
    
    keepOnAppending= keepOnAppending2;
